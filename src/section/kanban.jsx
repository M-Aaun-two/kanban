...
export const CustomKanban = () => {
  return (
    <div className="h-screen w-full bg-neutral-900 text-neutral-50 overflow-x-auto">
      <Board />
    </div>
  );
};
...
const Column = ({ title, headingColor, cards, column, setCards }) => {
  ...
  return (
    <div className="flex flex-col w-full sm:w-80 md:w-96 lg:w-1/4 p-2">
      ...
      <div
        ...
        className={`flex flex-col h-full p-2 transition-colors ${
...
const BurnBarrel = ({ setCards }) => {
  ...
  return (
    <div
      ...
      onDragOver={handleDragOver}
      onDragLeave={handleDragLeave}
      className={`mt-4 grid h-56 w-56 shrink-0 place-content-center rounded border text-3xl ${
        active
